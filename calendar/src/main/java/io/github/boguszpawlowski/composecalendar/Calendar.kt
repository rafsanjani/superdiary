...
/**
 * [Calendar] implementation using a [DynamicSelectionState] as a selection
 * handler.
 * * Basic usage:
 * ```
 *  @Composable
 ...
 * @param showAdjacentMonths whenever to show or hide the days from
 *     adjacent months
 * @param horizontalSwipeEnabled whenever user is able to change the month
 *     by horizontal swipe
 * @param calendarState state of the composable
 * @param dayContent composable rendering the current day
 * @param monthHeader header for showing the current month and controls for
 *     changing it
 * @param daysOfWeekHeader header for showing captions for each day of week
 * @param monthContainer container composable for all the days in current
 *     month
 */
@Composable
...
/**
 * Composable for showing a calendar. The calendar state has to be provided
 * by the call site. If you want to use built-in implementation, check out:
 * [SelectableCalendar] - calendar composable handling selection that can
 * be changed at runtime [StaticCalendar] - calendar without any mechanism
 * for selection
 *
 * @param calendarState state of the composable
 * @param modifier
...
/**
 * Helper function for providing a [CalendarState] implementation with
 * selection mechanism.
 *
 ...
 * @param confirmSelectionChange callback for optional side-effects
 *     handling and vetoing the state change
 */
@Composable
...
/**
 * Helper function for providing a [CalendarState] implementation without a
 * selection mechanism.
 *
 * @param initialMonth initially rendered month
 */
